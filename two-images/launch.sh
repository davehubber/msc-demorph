...
#SBATCH --job-name=base_pit_loss     # Job name
#SBATCH --output=slurm_%x.%j.out     # File containing STDOUT output
#SBATCH --error=slurm_%x.%j.err      # File containing STDERR output. If ommited, use STDOUT.

# Commands / scripts to run (e.g., python3 train.py)

python train.py --dataset_path "/nas-ctm01/datasets/public/Oxford102Flowers/jpg" --run_name "base_pit_loss" --partition_file "partition.csv" --batch_size 512 --epochs 750