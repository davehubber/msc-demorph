...
python train.py --run_name "dual_prediction_fixed" --dataset_path "/nas-ctm01/datasets/public/Oxford102Flowers/jpg" --partition_file "partition.csv" --batch_size 128 --mode "eval"